...
`,Xi=()=>b(Zi,{children:[b(Dn,{children:["Please leave a message.",c("br",{}),"After the wedding, it will be delivered to the bride and groom."]}),c(Bi,{})]}),Zi=f.div`
  display: flex;
  flex-direction: column;
  gap: 8px;
  margin-bottom: 50px;
...
`,sa=f.button`
  ...
  justify-content: center;
  align-items: center;
`.withComponent("a"),ca=()=>{const{mapInfo:e,locationInfo:t}=te;return b(la,{children:[b(St,{children:[c(Ue,{children:t[1].title}),c(Ge,{children:t[1].desc}),c(aa,{src:e.googleMap})]}),b(St,{children:[c(Ue,{children:t[0].title}),c(Ge,{children:t[0].desc}),c(sa,{id:"google-calendar-link",target:"_blank",href:"",rel:"noreferrer",children:"Add to Calendar"})]})]})},la=f.div`
  width: 90%;
  display: flex;
  flex-direction: column;
`,St=f.div`
